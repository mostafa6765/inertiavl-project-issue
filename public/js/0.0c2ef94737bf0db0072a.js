...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      {},
      [
        _c("inertia-link", { attrs: { href: "/contact", method: "get" } }, [
          _vm._v("Contact Page >> inertia link")
        ])
      ],
      1
    ),
        ...
        "button",
        {
          ...
          on: {
            click: function($event) {
              return _vm.contactPage()
            }
          }
        },
        [_vm._v("Contact onclick")]
      )
    ])
  ])
}
  ...
  function() {
    ...
    return _c("div", {}, [
      _c("a", { attrs: { href: "/link" } }, [
        _vm._v("contact page >> normal anchro tag")
      ])
    ])
  }
]
